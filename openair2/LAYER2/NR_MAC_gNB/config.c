...
static void config_common(nr_cell_sched_t *cell, const nr_mac_config_t *config, NR_ServingCellConfigCommon_t *scc)
{
  ...
  AssertFatal(pusch_AntennaPorts > 0 && pusch_AntennaPorts * cell->beam_info.beams_per_period <= NR_MAC_MAX_RU_ANTENNA_PORTS,
              "pusch_AntennaPorts * beams_per_period must be in 1...%d\n",
